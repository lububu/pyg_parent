					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a ng-click="selectOption('${spec.attributeName}','${value}')" href="javascript:;" class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
						</div>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a ng-click="addToCart()" href="http://localhost:9107/cart/addGoodsToCartList.do?itemId={{sku.id}}&num={{num}}"  class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
